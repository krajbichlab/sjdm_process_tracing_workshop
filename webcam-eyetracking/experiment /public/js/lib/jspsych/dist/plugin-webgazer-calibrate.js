  ...
  class WebgazerCalibratePlugin {
      ...
      trial(display_element, trial) {
          ...
          const calibration_display_gaze_only = (pt) => {
             var duration = trial.time_per_point/1000 || 10;
              var pt_html = `<div id="calibration-point" style="width:${trial.point_size}px; height:${trial.point_size}px; border-radius:${trial.point_size}px; border: 1px solid #000; background-color: #333; position: fixed; left:${pt[0]}%; top:${pt[1]}%;"><div id="calibration_cnt" style="margin-top: 10px; font-family: 'Courier New', Courier, sans-serif; text-shadow: none; font-size: 1em; font-weight: bold;color: white;">0</div></div>`;
