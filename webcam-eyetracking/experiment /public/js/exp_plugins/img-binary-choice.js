var jsPsychBinaryChoiceImg = (function (jspsych) {
    'use strict';
  
    const info = {
        name: "img-binary-choice",
        parameters: {
            /**
  ...
  class jsPsychBinaryChoiceImg {
    ...
    //  var selected_color = 'rgb(5, 157, 190)';
     ...
     // new_html += '<div class="container-binary-choice">';
     // new_html += '<div class="container-binary-choice-column">';
      new_html += `<div id="left_state" ><img height='100%' width='100%'" src="${trial.stimulus[0]}"/></div>`;
      new_html += '</div>';
     // new_html += '<div class="container-binary-choice-column">';
      new_html += `<div id="right_state" ><img height='100%' width='100%'" src="${trial.stimulus[1]}"/></div>`;
    //  new_html += '</div>';
...
jsPsychBinaryChoiceImg.info = info;

return jsPsychBinaryChoiceImg;
